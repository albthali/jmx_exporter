...
public class JavaAgent {
    ...
    public static void premain(final String agentArgument, final Instrumentation instrumentation) throws Exception {
        ...
        try {
            ...
            final String prometheusExporterDelay = System.getenv("PROMETHEUS_EXPORTER_DELAY");

            if (prometheusExporterDelay != null){
                final int delay = Integer.parseInt(prometheusExporterDelay);
